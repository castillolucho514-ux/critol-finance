...
const data = [{ day: "Lun", value: 182 }, { day: "Mar", value: 185 }, { day: "Mié", value: 183 }, { day: "Jue", value: 188 }, { day: "Vie", value: 190 }];
const copy = {
  es: { title: "Tu mercado, con claridad", subtitle: "Cotizaciones y análisis para tomar mejores decisiones.", portfolio: "Cartera", quotes: "Cotizaciones", analysis: "Análisis", settings: "Configuración" },
  en: { title: "Your market, made clear", subtitle: "Quotes and analysis for better decisions.", portfolio: "Portfolio", quotes: "Quotes", analysis: "Analysis", settings: "Settings" }
};
...
export default function Dashboard() {
  ...
  return <main className="mx-auto min-h-screen max-w-6xl p-6">
    ...
    <section className="grid gap-6 md:grid-cols-2">
      <div><p className="text-emerald-400">Mercados abiertos</p><h1 className="text-4xl font-bold">{t.title}</h1><p className="mt-3 text-slate-400">{t.subtitle}</p></div>
